...
import { PYTHON, WEB_DEVELOPMENT, DATA_SCIENCE, AWS, DESIGN, MARKETING, FIGMA } from "../utils/constants";
    ...
    <TabsWrapper>
      <div className='tabs'>
        <ul className='flex flex-wrap'>
          ...
          <li className='tabs-head-item'>
            <button type="button" className={`tab-btn ${activeTab === FIGMA}`} onClick={() => tabHandler(FIGMA)}>Figma</button>
          </li>
        </ul>
